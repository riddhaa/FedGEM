...
param_clem = {'rad':2e1, 'local_steps':1, 't_steps':10, 'max_iter':10, 'aggregate_final':False, 'P':n_features}
...
filename = 'FedClem_cifar_'+str(int(timeit.default_timer()))+str(np.random.randint(0,high=1000))+'.mat'
