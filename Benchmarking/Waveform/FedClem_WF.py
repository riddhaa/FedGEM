...
def gen_data(perc_train, G, clusters_per_client=-1):
    ...
    x_all_raw = np.asarray(X)
    y_all_raw = np.asarray(y)[:,0]
...
filename = 'FedClem_WF_'+str(int(timeit.default_timer()))+str(np.random.randint(0,high=1000))+'.mat'
