...
def gen_data(perc_train, G, clusters_per_client=-1):
    ...
    x_all = np.load("x_data.npy")
    y_all = np.load("y_data.npy")
...
param_clem = {'rad':3e2, 'local_steps':1, 't_steps':10, 'max_iter':20, 'aggregate_final':False, 'P':n_features}
...
filename = 'FedClem_FMNIST_'+str(int(timeit.default_timer()))+str(np.random.randint(0,high=1000))+'.mat'
