...
for i = 1:num_exp
    filename = sprintf('FedClem_Abl_8_10_%d.mat',i);
    load(filename)
...
acc_clem_8_10_cla = mean(result_clem_vec);
acc_central_8_10_cla = mean(result_central_vec);

std_clem_8_10_cla = std(result_clem_vec);
std_central_8_10_cla = std(result_central_vec);

ave_n_cl_8_10_cla = mean(pred_cluster_vec);
std_n_cl_8_10_cla = std(pred_cluster_vec);