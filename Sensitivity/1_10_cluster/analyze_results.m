...
acc_clem_1_10_gro = mean(result_clem_vec);
acc_central_1_10_gro = mean(result_central_vec);

std_clem_1_10_gro = std(result_clem_vec);
std_central_1_10_gro = std(result_central_vec);

ave_n_cl_1_10_gro = mean(pred_cluster_vec);
std_n_cl_1_10_gro = std(pred_cluster_vec);