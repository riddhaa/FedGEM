...
for i = 1:num_exp
    filename = sprintf('FedClem_Abl_1_10_%d.mat',i);
    load(filename)
...
acc_clem_1_10_nom = mean(result_clem_vec);
acc_central_1_10_nom = mean(result_central_vec);

std_clem_1_10_nom = std(result_clem_vec);
std_central_1_10_nom = std(result_central_vec);

ave_n_cl_1_10_nom = mean(pred_cluster_vec);
std_n_cl_1_10_nom = std(pred_cluster_vec);