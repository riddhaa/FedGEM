...
acc_clem_2_10_nom = mean(result_clem_vec);
acc_central_2_10_nom = mean(result_central_vec);

std_clem_2_10_nom = std(result_clem_vec);
std_central_2_10_nom = std(result_central_vec);

ave_n_cl_2_10_nom = mean(pred_cluster_vec);
std_n_cl_2_10_nom = std(pred_cluster_vec);