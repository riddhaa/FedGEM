...
acc_clem_8_10_nom = mean(result_clem_vec);
acc_central_8_10_nom = mean(result_central_vec);

std_clem_8_10_nom = std(result_clem_vec);
std_central_8_10_nom = std(result_central_vec);

ave_n_cl_8_10_nom = mean(pred_cluster_vec);
std_n_cl_8_10_nom = std(pred_cluster_vec);